...
void Button::initButton(Adafruit_GFX *gfx, int16_t x, int16_t y,
...
*/
/**************************************************************************/
void Button::initButtonUL(Adafruit_GFX *gfx, int16_t x1,
...
*/
/**************************************************************************/
void Button::initButtonULwR(Adafruit_GFX *gfx, int16_t x1,
                            int16_t y1, uint16_t w, uint16_t h,
                            int16_t r, uint16_t outline,
                            uint16_t fill, uint16_t textcolor,
                            char *label, uint8_t textsize)
{
   _x1 = x1;
...
void Button::drawButton(bool inverted)
{
   ...
   _gfx->fillRoundRect(_x1, _y1, _w, _h, _r, fill);
   _gfx->drawRoundRect(_x1, _y1, _w, _h, _r, outline);
